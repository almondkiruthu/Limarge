  ...
  return (
    <>
      <div className="relative rounded-b-[2.5rem] bg-customBlue pb-96">
        ...
        <div className="invisible 3xl:visible 3xl:absolute 3xl:right-0 3xl:top-[70px]">
          <img
        ...
        <div className="flex flex-wrap gap-y-10 pt-10 2xl:gap-x-3 3xl:ml-[3.125rem] 3xl:gap-x-4  3xl:pl-0 3xl:pt-24">
        ...
        <div className="px-4 pt-[50px] text-center font-inter 3xl:pt-20">
