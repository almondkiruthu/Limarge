    ...
    <div className="mx-auto w-[90%] lg:w-full pt-6">
      <div className="mx-auto w-full max-w-md rounded-2xl accordion p-2">
        ...
        <Disclosure as="div" className="mt-1">
          {({ open }) => (
            <>
              <Disclosure.Button className=" font-archivo font-semibold flex w-full justify-between rounded-lg px-4 py-2 text-left text-[24px] lg:text-[1.75rem] text-white focus:outline-none focus-visible:ring focus-visible:ring-purple-500 focus-visible:ring-opacity-75">
        ...
        <Disclosure as="div" className="mt-1">
          {({ open }) => (
            <>
              <Disclosure.Button className=" font-archivo font-semibold flex w-full justify-between rounded-lg px-4 py-2 text-left text-[1.5rem] lg:text-[1.52rem] text-white focus:outline-none focus-visible:ring focus-visible:ring-purple-500 focus-visible:ring-opacity-75">
