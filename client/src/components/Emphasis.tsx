  ...
  return (
    <>
      <div className="bg-customBlue pb-12 text-white">
        <div className="container flex flex-wrap items-center justify-around sm:flex-col sm:sm:flex-nowrap sm:items-center sm:justify-center sm:gap-y-8 md:flex-row md:gap-x-[0.3rem] md:gap-y-0 lg:gap-x-[2rem] lg:pt-[3rem] xl:pt-[4rem] 2xl:gap-x-[4rem]">
