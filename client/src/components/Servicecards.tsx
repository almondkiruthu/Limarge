  ...
  return (
    <>
      <div className="flex flex-wrap gap-y-10 2xl:gap-x-14 2xl:gap-y-0 2xl:pl-0">
        {/* Education card */}
        <div className="education-card mx-auto rounded-[1.25rem] pb-2 pl-5 pr-5 pt-5 xl:mt-[4rem] xl:px-10 2xl:mt-20 2xl:pb-5 2xl:pt-10">
        ...
        <div className="business-card mx-auto rounded-[1.25rem]  pb-2 pl-5 pr-5 pt-5 xl:pb-5 xl:pt-10 2xl:px-10 2xl:pb-5">
        ...
        <div className="education-card mx-auto rounded-[1.25rem] pb-2 pl-5 pr-3 pt-5  xl:mt-[4rem] xl:px-9 xl:pb-5 xl:pt-10 2xl:mt-20 2xl:px-10 2xl:pb-0 2xl:pt-10">
