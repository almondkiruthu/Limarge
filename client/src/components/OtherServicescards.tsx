const OtherServicescards = () => {
  return (
    <>
      <div className="flex gap-14 ml-[256px] text-white">
        {/* Education card */}
        ...
        <div className="business-card pt-5 pr-10 pl-10 pb-10 rounded-[20px] ml-32">
        ...
        <div className="education-card p-10 rounded-[20px] mt-20 ml-24">
