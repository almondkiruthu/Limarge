...
const Testimonials = () => {
  ...
  return (
    <>
      <div className="testimonial-card relative mx-auto rounded-[2.5rem] p-5 text-white lg:top-[-9rem] md:max-w-[40.125rem] lg:max-w-[60.125rem] xl:top-[-9rem] xl:max-w-[68.125rem] 2xl:top-[-10rem] 2xl:max-w-[75.125rem] 2xl:p-20">
        <div>
