...
const Testimonials = () => {
  ...
  return (
    <>
      <div className="testimonial-card relative mx-auto rounded-[2.5rem] p-5 text-white sm:top-[-9rem] sm:max-w-[30.125rem] md:top-[-10rem] md:max-w-[40.125rem] lg:top-[-9rem] lg:max-w-[60.125rem] xl:top-[-9rem] xl:max-w-[68.125rem] 2xl:top-[-10rem] 2xl:max-w-[75.125rem] 2xl:p-20">
        <div>
